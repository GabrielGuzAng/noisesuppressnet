# Reporte de Consumo de Entrenamiento — V4_SWEEP/ALPHA_080

Generado: 2026-09-20T00:37:18.801290
...
| Val loss del mejor modelo | -0.5211 |
| Tiempo por época (promedio) | 3921.8 s (65.4 min) |
| **Tiempo total de entrenamiento** | **3.27 h** |
| Tiempo hasta convergencia | 2.20 h |
| Eficiencia útil | 67.2 % |
...
| **Consumo total** | **0.572 kWh** |
| Consumo útil (hasta convergencia) | 0.385 kWh |
...
| **Emisiones totales** | **0.172 kg CO₂** |
| Emisiones útiles | 0.115 kg CO₂ |
...
| **Costo equivalente total** | **$1.14 USD** |
