# Reporte de Consumo de Entrenamiento — V4_SWEEP/ALPHA_090

Generado: 2026-09-20T00:37:18.860836
...
| Val loss del mejor modelo | -0.1839 |
| Tiempo por época (promedio) | 3942.9 s (65.7 min) |
| **Tiempo total de entrenamiento** | **3.29 h** |
| Tiempo hasta convergencia | 3.29 h |
...
| **Consumo total** | **0.575 kWh** |
| Consumo útil (hasta convergencia) | 0.575 kWh |
...
| **Emisiones totales** | **0.173 kg CO₂** |
| Emisiones útiles | 0.173 kg CO₂ |
...
| **Costo equivalente total** | **$1.15 USD** |
