# Reporte de Consumo de Entrenamiento — V4_SWEEP/ALPHA_095

Generado: 2026-09-20T00:37:18.948128
...
| Val loss del mejor modelo | -0.0453 |
| Tiempo por época (promedio) | 3879.4 s (64.7 min) |
| **Tiempo total de entrenamiento** | **3.23 h** |
| Tiempo hasta convergencia | 3.23 h |
...
| **Consumo total** | **0.566 kWh** |
| Consumo útil (hasta convergencia) | 0.566 kWh |
...
| **Emisiones totales** | **0.170 kg CO₂** |
| Emisiones útiles | 0.170 kg CO₂ |
