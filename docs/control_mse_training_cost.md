# Reporte de Consumo de Entrenamiento — V4_SWEEP/CONTROL_MSE

Generado: 2026-09-20T00:37:18.992959
...
| Val loss del mejor modelo | 0.1211 |
| Tiempo por época (promedio) | 1903.0 s (31.7 min) |
| **Tiempo total de entrenamiento** | **1.59 h** |
| Tiempo hasta convergencia | 1.59 h |
...
| **Consumo total** | **0.278 kWh** |
| Consumo útil (hasta convergencia) | 0.278 kWh |
...
| **Emisiones totales** | **0.083 kg CO₂** |
| Emisiones útiles | 0.083 kg CO₂ |
...
| **Costo equivalente total** | **$0.56 USD** |
