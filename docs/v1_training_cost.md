# Reporte de Consumo de Entrenamiento — V1

Generado: 2026-08-02T15:49:31.471908
...
| Val loss del mejor modelo | 0.0724 |
| Tiempo por época (promedio) | 1913.1 s (31.9 min) |
| **Tiempo total de entrenamiento** | **15.94 h** |
| Tiempo hasta convergencia | 10.15 h |
| Eficiencia útil | 63.7 % |
...
| **Consumo total** | **2.790 kWh** |
| Consumo útil (hasta convergencia) | 1.776 kWh |
...
| **Emisiones totales** | **0.837 kg CO₂** |
| Emisiones útiles | 0.533 kg CO₂ |
...
| **Costo equivalente total** | **$5.58 USD** |
