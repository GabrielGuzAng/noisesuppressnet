# Reporte de Consumo de Entrenamiento — V3

Generado: 2026-09-19T13:42:31.323320
...
| Época del mejor modelo | 21 |
| Val loss del mejor modelo | 0.0821 |
| Tiempo por época (promedio) | 1888.2 s (31.5 min) |
| **Tiempo total de entrenamiento** | **15.73 h** |
| Tiempo hasta convergencia | 11.02 h |
| Eficiencia útil | 70.0 % |
...
| **Consumo total** | **2.754 kWh** |
| Consumo útil (hasta convergencia) | 1.928 kWh |
...
| **Emisiones totales** | **0.826 kg CO₂** |
| Emisiones útiles | 0.578 kg CO₂ |
| Equivalencia | ≈ 3.3 km en auto naftero |
...
| **Costo equivalente total** | **$5.51 USD** |
