# Reporte de Consumo de Entrenamiento — V3B

Generado: 2026-09-19T13:42:31.369555
...
| Época del mejor modelo | 5 |
| Val loss del mejor modelo | 0.0864 |
| Tiempo por época (promedio) | 1932.4 s (32.2 min) |
| **Tiempo total de entrenamiento** | **5.37 h** |
| Tiempo hasta convergencia | 2.69 h |
| Eficiencia útil | 50.1 % |
...
| **Consumo total** | **0.939 kWh** |
| Consumo útil (hasta convergencia) | 0.471 kWh |
...
| **Emisiones totales** | **0.282 kg CO₂** |
| Emisiones útiles | 0.141 kg CO₂ |
| Equivalencia | ≈ 1.1 km en auto naftero |
...
| **Costo equivalente total** | **$1.88 USD** |
