# Reporte de Consumo de Entrenamiento — V3E

Generado: 2026-09-19T13:42:31.409631
...
| Época del mejor modelo | 14 |
| Val loss del mejor modelo | 0.0843 |
| Tiempo por época (promedio) | 1899.8 s (31.7 min) |
| **Tiempo total de entrenamiento** | **13.19 h** |
| Tiempo hasta convergencia | 7.40 h |
| Eficiencia útil | 56.1 % |
...
| **Consumo total** | **2.309 kWh** |
| Consumo útil (hasta convergencia) | 1.294 kWh |
...
| **Emisiones totales** | **0.693 kg CO₂** |
| Emisiones útiles | 0.388 kg CO₂ |
...
| **Costo equivalente total** | **$4.62 USD** |
