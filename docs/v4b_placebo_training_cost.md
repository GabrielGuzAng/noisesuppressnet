# Reporte de Consumo de Entrenamiento — V4B/V4B_PLACEBO

Generado: 2026-09-20T00:37:19.112509
...
|---------|-------|
| Épocas ejecutadas | 3 |
| Época del mejor modelo | 1 |
| Val loss del mejor modelo | 0.0803 |
| Tiempo por época (promedio) | 1867.2 s (31.1 min) |
| **Tiempo total de entrenamiento** | **1.56 h** |
| Tiempo hasta convergencia | 0.52 h |
| Eficiencia útil | 33.3 % |
...
| **Consumo total** | **0.272 kWh** |
| Consumo útil (hasta convergencia) | 0.091 kWh |
...
| **Emisiones totales** | **0.082 kg CO₂** |
| Emisiones útiles | 0.027 kg CO₂ |
| Equivalencia | ≈ 0.3 km en auto naftero |
...
| **Costo equivalente total** | **$0.54 USD** |
