# Reporte de Consumo de Entrenamiento — V5_S44

Generado: 2026-09-19T13:42:31.611222
...
| Época del mejor modelo | 16 |
| Val loss del mejor modelo | -0.0792 |
| Tiempo por época (promedio) | 1922.7 s (32.0 min) |
| **Tiempo total de entrenamiento** | **13.35 h** |
| Tiempo hasta convergencia | 8.57 h |
| Eficiencia útil | 64.2 % |
...
| **Consumo total** | **2.337 kWh** |
| Consumo útil (hasta convergencia) | 1.499 kWh |
...
| **Emisiones totales** | **0.701 kg CO₂** |
| Emisiones útiles | 0.450 kg CO₂ |
...
| **Costo equivalente total** | **$4.67 USD** |
