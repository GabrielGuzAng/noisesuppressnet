# Reporte de Consumo de Entrenamiento — V5

Generado: 2026-09-19T13:42:31.531341
...
| Tiempo por época (promedio) | 1907.7 s (31.8 min) |
| **Tiempo total de entrenamiento** | **13.25 h** |
| Tiempo hasta convergencia | 11.06 h |
| Eficiencia útil | 83.5 % |
...
| **Consumo total** | **2.318 kWh** |
| Consumo útil (hasta convergencia) | 1.936 kWh |
...
| **Emisiones totales** | **0.696 kg CO₂** |
| Emisiones útiles | 0.581 kg CO₂ |
...
| **Costo equivalente total** | **$4.64 USD** |
