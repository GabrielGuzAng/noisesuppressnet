# Reporte de Consumo de Entrenamiento — V6_GATE

Generado: 2026-09-19T13:42:31.652095
...
| Val loss del mejor modelo | -0.0688 |
| Tiempo por época (promedio) | 1920.4 s (32.0 min) |
| **Tiempo total de entrenamiento** | **3.20 h** |
| Tiempo hasta convergencia | 1.08 h |
| Eficiencia útil | 33.7 % |
...
| **Consumo total** | **0.560 kWh** |
| Consumo útil (hasta convergencia) | 0.189 kWh |
...
| **Emisiones totales** | **0.168 kg CO₂** |
| Emisiones útiles | 0.057 kg CO₂ |
