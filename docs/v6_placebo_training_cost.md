# Reporte de Consumo de Entrenamiento — V6_PLACEBO

Generado: 2026-09-19T13:42:31.691848
...
| Val loss del mejor modelo | -0.0662 |
| Tiempo por época (promedio) | 1873.7 s (31.2 min) |
| **Tiempo total de entrenamiento** | **3.12 h** |
| Tiempo hasta convergencia | 1.04 h |
...
| **Consumo total** | **0.546 kWh** |
| Consumo útil (hasta convergencia) | 0.182 kWh |
...
| **Emisiones totales** | **0.164 kg CO₂** |
| Emisiones útiles | 0.055 kg CO₂ |
...
| **Costo equivalente total** | **$1.09 USD** |
