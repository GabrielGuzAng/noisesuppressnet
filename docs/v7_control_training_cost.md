# Reporte de Consumo de Entrenamiento — V7_CONTROL

Generado: 2026-09-19T13:42:31.772965
...
| Val loss del mejor modelo | -0.0563 |
| Tiempo por época (promedio) | 1905.2 s (31.8 min) |
| **Tiempo total de entrenamiento** | **10.58 h** |
| Tiempo hasta convergencia | 10.05 h |
| Eficiencia útil | 94.9 % |
...
| **Consumo total** | **1.852 kWh** |
| Consumo útil (hasta convergencia) | 1.758 kWh |
...
| **Costo equivalente total** | **$3.70 USD** |
