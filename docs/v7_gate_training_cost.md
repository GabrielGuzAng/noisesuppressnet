# Reporte de Consumo de Entrenamiento — V7_GATE

Generado: 2026-09-19T13:42:31.732489
...
| Época del mejor modelo | 18 |
| Val loss del mejor modelo | -0.0632 |
| Tiempo por época (promedio) | 1907.1 s (31.8 min) |
| **Tiempo total de entrenamiento** | **10.60 h** |
| Tiempo hasta convergencia | 9.52 h |
| Eficiencia útil | 89.8 % |
...
| **Consumo total** | **1.854 kWh** |
| Consumo útil (hasta convergencia) | 1.665 kWh |
...
| **Emisiones totales** | **0.556 kg CO₂** |
| Emisiones útiles | 0.500 kg CO₂ |
...
| **Costo equivalente total** | **$3.71 USD** |
